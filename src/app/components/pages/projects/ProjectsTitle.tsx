...
export default function ProjectsTitle() {
  ...
  return (
    <div className="theme-default-padding-x theme-default-padding-y">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-[20px] md:gap-[50px] lg:gap-[100px] py-[20px]">
        <div className="flex flex-col sm:flex-row gap-[20px]">
          <Dropdown
            options={["All Categories", "Frontend", "Backend", "Fullstack"]}
            value={selectedRole}
          ...
          />
          <Dropdown
            options={["All Years", "2023", "2022", "2021"]}
            value={selectedYear}
        ...
        <p className="font-bold text-md sm:text-lg">12 Completed projects</p>
      </div>
