...
export default function AboutBanner() {
  return (
    <div className="theme-default-padding-x theme-default-padding-y">
      <MotionElement
        variant="scale"
        className="flex flex-col justify-center items-center lg:min-h-[500px] theme-bg-foreground theme-inverted-foreground rounded-[15px] p-[30px]"
      >
        <MotionElement variant="scale" delay={0.08}>
          <SpecialStarIcon className="w-[24px] h-[24px] mb-[10px]" />
        </MotionElement>
        <MotionElement variant="clip" delay={0.12}>
        ...
        <MotionElement
          variant="rise"
          delay={0.18}
          className="text-[18px] md:text-[24px] text-center w-11/12 lg:w-8/12 mb-[50px]"
        >
          I&apos;m currently available and excited to take on new projects.
          Let&apos;s connect and turn your ideas into reality.
        </MotionElement>
        <MotionElement variant="scale" delay={0.24}>
          <Button
            text="Book a call"
            varient="secondary"
